    ...
    return
        {
            layers =
                {
                    {
                        filename = "__RampantArsenalFork__/graphics/yuokiTani/entities/advanced-laser-sheet.png",
                        priority = "high",
                        width = 256,
                        height = 256,
                        line_length = 8,
                    ...
                    {
                        filename = "__RampantArsenalFork__/graphics/yuokiTani/entities/advanced-laser-sheet-mask.png",
                        flags = { "mask" },
                        width = 256,
                        height = 256,
                        line_length = 8,
    ...
    return
        {
            layers =
                {
                    {
                        filename = "__RampantArsenalFork__/graphics/yuokiTani/entities/r1_sheet.png",
                        priority = "high",
                        width = 96,
                        height = 80,
                        line_length = 16,
...
function lasers.enable()
    ...
    local entity = {
        name = "advanced-laser",
        icon = "__RampantArsenalFork__/graphics/icons/advancedLaserTurret.png",
        miningTime = 1,
        health = 2000,
    ...
    local entity1 = {
        name = "lightning",
        icon = "__RampantArsenalFork__/graphics/icons/lightningTurret.png",
		icon_size = 32,
        miningTime = 1,
        health = 1200,
        hasBaseDirection = true,
    ...
    local entity2 = {
        name = "advanced-beam",
        icon = "__RampantArsenalFork__/graphics/icons/advanced-beam-turret.png",
        miningTime = 1,
        health = 1400,
        energySource = {
            type = "electric",
