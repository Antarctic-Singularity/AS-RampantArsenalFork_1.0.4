...
function technologies.enable()
    ...
    local capsuleTurretTech = makeTechnology({
            ...
            icon = "__RampantArsenalFork__/graphics/technology/capsule-turrets.png",
            effects = {},
            ingredients = {
    ...
    local shotgunTurretTech = makeTechnology({
            ...
            icon = "__RampantArsenalFork__/graphics/technology/shotgun-turrets.png",
            effects = {},
    ...
    local rocketTurretTech = makeTechnology({
            ...
            icon = "__RampantArsenalFork__/graphics/technology/rocket-turrets.png",
            effects = {},
            ingredients = {
                {"automation-science-pack", 1},
                {"logistic-science-pack", 1},
    ...
    local cannonTech = makeTechnology({
            ...
            icon = "__RampantArsenalFork__/graphics/technology/cannon-turrets.png",
            effects = {},
            ingredients = {
                {"automation-science-pack", 1},
                {"logistic-science-pack", 1},
    ...
    makeTechnology({
        ...
        local cannonTurretDamage1 = makeTechnology({
                ...
                icon = "__RampantArsenalFork__/graphics/technology/cannon-turret-damage.png",
                upgrade = true,
                effects = {},
                ingredients = {
                    {"automation-science-pack", 1},
		...
		makeTechnology({
				...
				icon = "__RampantArsenalFork__/graphics/technology/artillery-shell-damage.png",
				upgrade = true,
				maxLevel = "infinite",
				effects = {
					{
		...
		makeTechnology({
				...
				prerequisites = {"artillery", "space-science-pack"},
				icon = "__RampantArsenalFork__/graphics/technology/artillery-damage.png",
				upgrade = true,
				maxLevel = "infinite",
				effects = {
					{
    ...
    if settings.startup["rampant-arsenal-enableAmmoTypes"].value then
        local incendiary = makeTechnology({
                name="incendiary",
                icon="__RampantArsenalFork__/graphics/technology/incendiary.png",
        ...
        local napalm = makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/incendiary-napalm.png",
        ...
        local he = makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/he-ordnance.png",
        ...
        local bioweapons = makeTechnology({
                name="bio-weapons",
                icon="__RampantArsenalFork__/graphics/technology/biowarfare.png",
		...
		makeTechnology({
				name = "paralysis",
				icon="__RampantArsenalFork__/graphics/technology/paralysis.png",
        ...
        local bioCapsules = makeTechnology({
                name="bio-capsules",
                icon="__RampantArsenalFork__/graphics/technology/bio-capsules.png",
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/incendiary-grenades.png",
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/incendiary-landmines.png",
        ...
        makeTechnology({
                name="bio-landmine",
                icon="__RampantArsenalFork__/graphics/technology/bio-landmines.png",
        ...
        makeTechnology({
                name="he-landmine",
                icon="__RampantArsenalFork__/graphics/technology/he-landmines.png",
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/incendiary-cannon-shells.png",
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/bio-cannon-shells.png",
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/he-cannon-shells.png",
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/incendiary-artillery-shells.png",
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/bio-artillery-shells.png",
        ...
        local heGrenades = makeTechnology({
                name="he-grenades",
                icon="__RampantArsenalFork__/graphics/technology/he-grenades.png",
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/he-artillery-shells.png",
        ...
        makeTechnology({
                name="bio-grenades",
                icon="__RampantArsenalFork__/graphics/technology/bio-grenades.png",
        ...
        makeTechnology({
                name = "bio-bullets",
                icon="__RampantArsenalFork__/graphics/technology/bio-bullets.png",
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/bio-shotgun-shells.png",
                prerequisites = {bioweapons},
                effects = {},
                count = 75,
                ingredients = {
        ...
        makeTechnology({
                name = "bio-rockets",
                icon="__RampantArsenalFork__/graphics/technology/bio-rockets.png",
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/incendiary-bullets.png",
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/incendiary-shotgun-shells.png",
                prerequisites = {incendiary},
                effects = {},
                count = 75,
                ingredients = {
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/incendiary-rockets.png",
        ...
        makeTechnology({
                name = "he-bullets",
                icon="__RampantArsenalFork__/graphics/technology/he-bullets.png",
                prerequisites = {he},
                effects = {},
                count = 75,
                ingredients = {
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/he-shotgun-shells.png",
                prerequisites = {he},
                effects = {},
                count = 75,
                ingredients = {
        ...
        makeTechnology({
                name = "he-rockets",
                icon="__RampantArsenalFork__/graphics/technology/he-rockets.png",
    ...
    local lightningTurretTech = makeTechnology({
            ...
            icon = "__RampantArsenalFork__/graphics/technology/lightning-turrets.png",
            effects = {},
            ingredients = {
                {"automation-science-pack", 1},
                {"logistic-science-pack", 1},
    ...
    makeTechnology({
            name = "boosters",
            icon="__RampantArsenalFork__/graphics/technology/boosters.png",
    ...
    local regeneration = makeTechnology({
            name = "regeneration",
            icon="__RampantArsenalFork__/graphics/technology/regeneration.png",
    ...
    makeTechnology({
            ...
            icon="__RampantArsenalFork__/graphics/technology/mending-walls.png",
    ...
    local regenerationTurrets = makeTechnology({
            name = "regeneration-turrets",
            icon="__RampantArsenalFork__/graphics/technology/medic-turrets.png",
    ...
    local regenerationTurrets = makeTechnology({
            name = "regeneration-capsules-mk2",
            icon="__RampantArsenalFork__/graphics/technology/medic-turrets.png",
            prerequisites = {regenerationTurrets, "military-4"},
            effects = {},
            count = 50,
            ingredients = {
                {"automation-science-pack", 1},
    ...
    local turrets2 = makeTechnology({
            name = "turrets-2",
            icon="__RampantArsenalFork__/graphics/technology/turrets-2.png",
    ...
    if settings.startup["rampant-arsenal-enableVehicle"].value then
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/nuclear-railway.png",
        ...
        makeTechnology({
                name = "nuclear-tanks",
                icon="__RampantArsenalFork__/graphics/technology/nuclear-tanks.png",
        ...
        makeTechnology({
                name = "nuclear-cars",
                icon="__RampantArsenalFork__/graphics/technology/nuclear-cars.png",
    ...
    if settings.startup["rampant-arsenal-enableEquipment"].value then
        local powerArmorMk3Tech = makeTechnology({
                name = "power-armor-mk3",
                icon="__RampantArsenalFork__/graphics/technology/power-armor-mk3.png",
		...
		if mods["space-age"] or mods["mech-armor"]  then
			local modPath = (mods["space-age"] and "__space-age__") or (mods["mech-armor"] and "__mech-armor__")
			local ingredients
			...
			makeTechnology({
					name = "combat-mech-armor",
					icon= modPath.."/graphics/technology/mech-armor.png",
					iconSize = 256,
					prerequisites = {powerArmorMk3Tech, "mech-armor"},
					effects = {},
					count = 1000,
    ...
    local stoneWalls2 = makeTechnology({
			name = "stone-walls-2",
    ...
    makeTechnology({
            ...
            iconSize=256,
            iconMipmaps=4,
            prerequisites = {"military-4", stoneWalls2},
            effects = {},
            count = 100,
            ingredients = {
                {"automation-science-pack", 1},
    ...
    if (not mods["RPGsystem"]) then
        local characterHealthBonus1 = makeTechnology({
                ...
                icon = "__RampantArsenalFork__/graphics/technology/character-bonus-health.png",
                upgrade = true,
                effects = {
                    {
    ...
    if settings.startup["rampant-arsenal-enableEquipment"].value then
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/personal-shotgun-defense-equipment.png",
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/personal-cannon-defense-equipment.png",
                prerequisites = {"personal-laser-defense-equipment",
                                 "military-4",
                                 "processing-unit",
                                 cannonTech,
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/personal-lightning-defense-equipment.png",
                prerequisites = {"personal-laser-defense-equipment",
                                 "military-4",
                                 "processing-unit",
                                 lightningTurretTech,
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/personal-bullets-defense-equipment.png",
        ...
        makeTechnology({
                ...
                icon="__RampantArsenalFork__/graphics/technology/personal-slow-defense-equipment.png",
