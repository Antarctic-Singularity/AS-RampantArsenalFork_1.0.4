...
function artillery.enable()
	...
	liteArtillery.next_upgrade = nil
    ...
    local incendiaryArtilleryShellAmmo = makeAmmo({
            ...
            icon = "__RampantArsenalFork__/graphics/icons/incendiary-artillery-shell.png",
    ...
    local heArtilleryShellAmmo = makeAmmo({
            name = "he-artillery",
            icon = "__RampantArsenalFork__/graphics/icons/he-artillery-shell.png",
    ...
    local bioArtilleryShellAmmo = makeAmmo({
            name = "bio-artillery",
            icon = "__RampantArsenalFork__/graphics/icons/bio-artillery-shell.png",
    ...
    local nuclearArtilleryShellAmmo = makeAmmo({
            ...
            icon = "__RampantArsenalFork__/graphics/icons/nuclear-artillery-shell.png",
