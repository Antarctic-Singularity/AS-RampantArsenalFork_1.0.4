    ...
    return
        {
            layers =
                {
                    {
                        filename = "__RampantArsenalFork__/graphics/yuokiTani/entities/cannon-mk1-sheet.png",
                        priority = "high",
                        width = 128,
                        height = 128,
                        line_length = 8,
...
-- 		{
-- 		    {
-- 			filename = "__RampantArsenalFork__/graphics/entities/cannon-mk1-sheet.png",
-- 			priority = "high",
-- 			width = 128,
-- 			height = 128,
-- 			line_length = 8,
    ...
    return
        {
            layers =
                {
                    {
                        filename = "__RampantArsenalFork__/graphics/yuokiTani/entities/shotgun-turret-sheet.png",
                        priority = "high",
                        width = 90,
                        height = 90,
                        line_length = 8,
    ...
    return
        {
            layers =
                {
                    {
                        filename = "__RampantArsenalFork__/graphics/yuokiTani/entities/cannon-mk2-sheet.png",
                        priority = "high",
                        width = 128,
                        height = 128,
                        line_length = 8,
    ...
    return
        {
            layers =
                {
                    {
                        filename = "__RampantArsenalFork__/graphics/yuokiTani/entities/cannon-mk2-place.png",
                        priority = "high",
                        width = 128,
                        height = 128,
    ...
    return
        {
            layers =
                {
                    {
                        filename = "__RampantArsenalFork__/graphics/yuokiTani/entities/cr-sheet.png",
                        priority = "high",
                        width = 256,
                        height = 256,
                        line_length = 8,
...
function cannons.enable()
    local cannonAttributes = {
        name = "cannon",
        icon = "__RampantArsenalFork__/graphics/icons/cannonTurret.png",
        miningTime = 5,
        health = 2500,
    ...
    local rapidCannonAttributes = {
        name = "rapid-cannon",
        icon = "__RampantArsenalFork__/graphics/icons/rapidCannonTurret.png",
        miningTime = 5,
        health = 2000,
    ...
    local advFlamethrowerAttributes = {
        ...
        icon = "__RampantArsenalFork__/graphics/icons/suppressionCannonTurret.png",
        miningTime = 5,
        health = 3000,
		collisionBox = {{-2, -2.2 }, {2, 2.2}},		--collisionBox = {{-1.7, -2.2 }, {1.7, 2.2}},
        selectionBox = {{-2, -2.5 }, {2, 2.5}},
        order = "b[turret]-c[zflamethrower-turret]",
        pipeConnections = {
            {flow_direction = "input-output", direction = defines.direction.west, position = {-1.5, 2.0}},
            {flow_direction = "input-output", direction = defines.direction.east, position = {1.5, 2.0} }
        },
    ...
    if settings.startup["rampant-arsenal-enableAmmoTypes"].value then
        fluidBonuses[#fluidBonuses+1] = {type = "napalm-fluid-rampant-arsenal", damage_modifier = 3}
    end
	...
	log("acidTurret:"..serpent.dump(acidTurret))
    ...
    local shotgunAttributes = {
        name = "shotgun",
        icon = "__RampantArsenalFork__/graphics/icons/shotgunTurret.png",
        miningTime = 1,
        health = 1000,
        hasBaseDirection = true,
    ...
    makeRecipe({
            ...
            time = 35,
            ingredients = {
                {type = "item", name = cannonTurretItem, amount = 1},
    ...
    if settings.startup["rampant-arsenal-enableAmmoTypes"].value then
        local incendiaryCannonShellAmmo = makeAmmo({
                ...
                icon = "__RampantArsenalFork__/graphics/icons/incendiary-cannon-shell.png",
        ...
        local heCannonShellAmmo = makeAmmo({
                ...
                icon = "__RampantArsenalFork__/graphics/icons/he-cannon-shell.png",
        ...
        local bioCannonShellAmmo = makeAmmo({
                ...
                icon = "__RampantArsenalFork__/graphics/icons/bio-cannon-shell.png",
