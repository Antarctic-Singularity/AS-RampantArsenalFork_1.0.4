    ...
    return
        {
            layers =
                {
                    {
                        filename = "__RampantArsenalFork__/graphics/yuokiTani/entities/arty2x2-sheet.png",
                        priority = "high",
                        width = 168,
                        height = 168,
                        line_length = 8,
...
function capsules.enable()
    ...
    local slowCapsules = makeAmmo({
            ...
            icon = "__RampantArsenalFork__/graphics/icons/slowdown-capsule-ammo.png",
            magSize = 1,
    ...
    local paralysisCapsules = makeAmmo({
            ...
            icon = "__RampantArsenalFork__/graphics/icons/paralysis-capsule-ammo.png",
            magSize = 1,
            subgroup = "launcher-capsule",
            order = "i[capsule]",
            stackSize = 200,
    ...
    local repairCapsules = makeAmmo({
            name = "repair-capsule",
            icon = "__RampantArsenalFork__/graphics/icons/repair-capsule-ammo.png",
            magSize = 1,
            subgroup = "launcher-capsule",
            order = "j[capsule]",
            stackSize = 200,
    ...
    local poisonCapsules = makeAmmo({
            name = "poison-capsule",
            icon = "__RampantArsenalFork__/graphics/icons/poison-capsule-ammo.png",
            magSize = 1,
            subgroup = "launcher-capsule",
            order = "f[capsule]",
            stackSize = 200,
    ...
    local distractorCapsules = makeAmmo({
            ...
            icon = "__RampantArsenalFork__/graphics/icons/distractor-capsule-ammo.png",
            magSize = 1,
            subgroup = "launcher-capsule",
            order = "l[capsule]",
            stackSize = 200,
    ...
    local defenderCapsules = makeAmmo({
            ...
            icon = "__RampantArsenalFork__/graphics/icons/defender-capsule-ammo.png",
            magSize = 1,
            subgroup = "launcher-capsule",
            order = "k[capsule]",
            stackSize = 200,
    ...
    local destroyerCapsules = makeAmmo({
            ...
            icon = "__RampantArsenalFork__/graphics/icons/destroyer-capsule-ammo.png",
            magSize = 1,
            subgroup = "launcher-capsule",
            order = "m[capsule]",
            stackSize = 200,
    ...
    local landmineCapsules = makeAmmo({
            ...
            icon = "__RampantArsenalFork__/graphics/icons/landmine-capsule-ammo.png",
            magSize = 1,
            subgroup = "launcher-capsule",
            order = "n[capsule]",
            stackSize = 200,
    ...
    local grenadeCapsules = makeAmmo({
            ...
            icon = "__RampantArsenalFork__/graphics/icons/grenade-capsule-ammo.png",
            magSize = 1,
            subgroup = "launcher-capsule",
            order = "a[capsule]",
            stackSize = 200,
    ...
    if settings.startup["rampant-arsenal-enableAmmoTypes"].value then
        ...
        local toxicCapsules = makeAmmo({
                name = "toxic-capsule",
                icon = "__RampantArsenalFork__/graphics/icons/toxic-capsule-ammo.png",
                magSize = 1,
                subgroup = "launcher-capsule",
                order = "g[capsule]",
                stackSize = 200,
        ...
        local incendiaryLandmineCapsules = makeAmmo({
                ...
                icon = "__RampantArsenalFork__/graphics/icons/incendiary-landmine-capsule-ammo.png",
                magSize = 1,
                subgroup = "launcher-capsule",
                order = "w[capsule]",
                stackSize = 200,
        ...
        local heLandmineCapsules = makeAmmo({
                ...
                icon = "__RampantArsenalFork__/graphics/icons/he-landmine-capsule-ammo.png",
                magSize = 1,
                subgroup = "launcher-capsule",
                order = "p[capsule]",
                stackSize = 200,
        ...
        local bioLandmineCapsules = makeAmmo({
                ...
                icon = "__RampantArsenalFork__/graphics/icons/bio-landmine-capsule-ammo.png",
                magSize = 1,
                subgroup = "launcher-capsule",
                order = "o[capsule]",
                stackSize = 200,
        ...
        local nuclearLandmineCapsules = makeAmmo({
                ...
                icon = "__RampantArsenalFork__/graphics/icons/nuclear-landmine-capsule-ammo.png",
                magSize = 1,
                subgroup = "launcher-capsule",
                order = "x[capsule]",
                stackSize = 200,
        ...
        local bioGrenadeCapsules = makeAmmo({
                ...
                icon = "__RampantArsenalFork__/graphics/icons/bio-grenade-capsule-ammo.png",
                magSize = 1,
                subgroup = "launcher-capsule",
                order = "b[capsule]",
                stackSize = 200,
        ...
        local heGrenadeCapsules = makeAmmo({
                ...
                icon = "__RampantArsenalFork__/graphics/icons/he-grenade-capsule-ammo.png",
                magSize = 1,
                subgroup = "launcher-capsule",
                order = "c[capsule]",
                stackSize = 200,
        ...
        local incendiaryGrenadeCapsules = makeAmmo({
                ...
                icon = "__RampantArsenalFork__/graphics/icons/incendiary-grenade-capsule-ammo.png",
                magSize = 1,
                subgroup = "launcher-capsule",
                order = "d[capsule]",
                stackSize = 200,
    ...
    local clusterGrenadeCapsules = makeAmmo({
            ...
            icon = "__RampantArsenalFork__/graphics/icons/cluster-grenade-capsule-ammo.png",
            magSize = 1,
            subgroup = "launcher-capsule",
            order = "e[capsule]",
            stackSize = 200,
    ...
    local entity = {
        name = "capsule",
        icon = "__RampantArsenalFork__/graphics/icons/capsuleTurret.png",
        miningTime = 1,
        health = 1200,
