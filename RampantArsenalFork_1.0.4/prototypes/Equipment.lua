...
function Equipment.enable()
    ...
    local powerArmor = makeArmor({
            ...
            inventoryBonus = 60,
            icon = "__RampantArsenalFork__/graphics/icons/power-armor-mk3.png",
	...
	if mods["space-age"] or mods["mech-armor"] then
		...
		local combatMechArmor = makeArmor({
            name = "combat-mech",
            inventoryBonus = 60,
            icon = modPath.."/graphics/icons/mech-armor.png",
			icons = {{icon = modPath.."/graphics/icons/mech-armor.png", icon_size = 64, tint =  { 0.5, 0.9, 0.5, 1 }}},
            order = "f[mech-armor]-2",
		...
		makeRecipe({
				name = combatMechArmor,
				icon = modPath.."/graphics/icons/mech-armor.png",
				icons = {{icon = modPath.."/graphics/icons/mech-armor.png", icon_size = 64, tint =  { 0.5, 0.9, 0.5, 1 }}},
				enabled = false,
				ingredients = {
					{type = "item", name = "mech-armor", amount = 1},
					{type = "item", name = powerArmor, amount = 1}
				},
				result = combatMechArmor
		})

		addEffectToTech("rampant-arsenal-technology-combat-mech-armor",
						{
							type = "unlock-recipe",
							recipe = combatMechArmor
		})
	end
    ...
    local shieldMk3 = makeShield({
            name = "mk3",
            icon = "__RampantArsenalFork__/graphics/icons/energy-shield-mk3-equipment.png",
            picture = "__RampantArsenalFork__/graphics/equipment/energy-shield-mk3-equipment.png",
    ...
    local batteryMk3 = makeBattery({
            name = "mk3",
            icon = "__RampantArsenalFork__/graphics/icons/battery-mk3-equipment.png",
            picture = "__RampantArsenalFork__/graphics/equipment/battery-mk3-equipment.png",
    ...
    local generatorMk3 = makeGenerator({
            name = "mk3",
            icon = "__RampantArsenalFork__/graphics/icons/generator-mk3-equipment.png",
            picture = "__RampantArsenalFork__/graphics/equipment/generator-mk3-equipment.png",
    ...
    local generatorNuclear = makeGenerator({
            name = "nuclear",
            icon = "__RampantArsenalFork__/graphics/icons/generator-nuclear-equipment.png",
            picture = "__RampantArsenalFork__/graphics/equipment/generator-nuclear-equipment.png",
    ...
    local passiveShotgun = makePassiveDefense(
        {
            name = "shotgun",
            icon = "__RampantArsenalFork__/graphics/icons/personal-shotgun-defense-equipment.png",
            picture = "__RampantArsenalFork__/graphics/equipment/personal-shotgun-defense-equipment.png",
    ...
    local passiveCannon = makePassiveDefense(
        {
            name = "cannon",
            icon = "__RampantArsenalFork__/graphics/icons/personal-cannon-defense-equipment.png",
            picture = "__RampantArsenalFork__/graphics/equipment/personal-cannon-defense-equipment.png",
    ...
    local passiveLightning = makePassiveDefense(
        {
            name = "lightning",
            icon = "__RampantArsenalFork__/graphics/icons/personal-lightning-defense-equipment.png",
            picture = "__RampantArsenalFork__/graphics/equipment/personal-lightning-defense-equipment.png",
    ...
    local passiveBullets = makePassiveDefense(
        {
            name = "bullets",
            icon = "__RampantArsenalFork__/graphics/icons/personal-bullet-defense-equipment.png",
            picture = "__RampantArsenalFork__/graphics/equipment/personal-bullet-defense-equipment.png",
    ...
    local passiveSlow = makePassiveDefense(
        {
            name = "slow",
            icon = "__RampantArsenalFork__/graphics/icons/personal-slow-defense-equipment.png",
            picture = "__RampantArsenalFork__/graphics/equipment/personal-slow-defense-equipment.png",
