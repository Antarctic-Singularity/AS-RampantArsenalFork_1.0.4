    ...
    return
        {
            layers =
                {
                    {
                        filename = "__RampantArsenalFork__/graphics/yuokiTani/entities/zone-expander.png",
                        priority = "high",
                        width = 96,
                        height = 128,
                        line_length = 4,
...
function medic.enable()
    ...
    local medicTurretAttributes = {
        name = "medic",
        icon = "__RampantArsenalFork__/graphics/icons/zone-expander.png",
        miningTime = 1,
        health = 1000,
    ...
    local repairCapsules = makeAmmo({
            ...
            icon = "__RampantArsenalFork__/graphics/icons/medic-repair-pack.png",
    ...
    local repairCapsulesMk2 = makeAmmo({
            name = "self-repair-capsule-mk2",
            icons = {{icon = "__RampantArsenalFork__/graphics/icons/medic-repair-pack.png", icon_size = 32}, {icon = "__RampantArsenalFork__/graphics/icons/medic-repair-pack.png", scale = 0.8, shift = {10, 10}, icon_size = 32}},
            subgroup = "launcher-capsule",
            order = "y[turret-capsule]-2",
            magSize = 50,
            stackSize = 200,
			ammo_category = "turret-capsule",
            ammoType = {
                                                    ...
                                                    {
                                                        {
                                                            type = "create-entity",
															affects_target = true,
                                                            entity_name = "massive-strong-repair-cloud-rampant-arsenal",
                                                            show_in_tooltip = true
                                                        }
                                                    }
                                            }
    ...
    makeRecipe({
            name = repairCapsulesMk2,
            icons = {{icon = "__RampantArsenalFork__/graphics/icons/medic-repair-pack.png", icon_size = 32}, {icon = "__RampantArsenalFork__/graphics/icons/medic-repair-pack.png", scale = 0.8, shift = {10, 10}, icon_size = 32}},
            icon = "__RampantArsenalFork__/graphics/icons/medic-repair-pack.png",
            enabled = false,
            ingredients = {
                {type = "item", name = repairCapsules, amount = 4},
                {type = "item", name = "advanced-circuit", amount = 1}
            },
            result = repairCapsulesMk2
    })
    ...
    addEffectToTech("regeneration-capsules-mk2",
                    {
                        type = "unlock-recipe",
                        recipe = repairCapsulesMk2
    })
